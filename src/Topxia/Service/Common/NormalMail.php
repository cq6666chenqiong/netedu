...
class NormalMail extends Mail
{
    ...
    {
        return array(
            'title' => "重设{$this->params['nickname']}在{$this->setting('site.name', 'myBanana')}的密码",
    ...
    {
        return array(
            'title' => "重设{$this->params['nickname']}在{$this->setting('site.name', 'myBanana')}的电子邮箱",
    ...
    {
        return array(
            'title' => "验证{$this->params['nickname']}在{$this->setting('site.name', 'myBanana')}的电子邮箱",
