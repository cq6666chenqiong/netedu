...
class myBananaAppClient implements AppClient
{
    protected $userAgent = 'Open myBanana App Client 1.0';

    protected $connectTimeout = 5;

    protected $timeout = 5;

    private $apiUrl = 'http://open.myBanana.com/app_api';
