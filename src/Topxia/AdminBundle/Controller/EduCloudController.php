...
use Topxia\Service\CloudPlatform\Client\myBananaOpenClient;
...
class EduCloudController extends BaseController
{
    ...
    public function myCloudAction(Request $request)
    {
        ...
        $unTrial     = file_get_contents('http://open.myBanana.com/api/v1/block/cloud_guide');
...
//概览页，服务概况页
    ...
    public function myCloudOverviewAction(Request $request)
    {
        try {
            ...
            $myBananaOpenClient = new myBananaOpenClient;
        ...
        $notices = $myBananaOpenClient->getNotices();
...
//如果要更改短信策略则同步到数据库
    ...
    {
        $trial     = file_get_contents('http://open.myBanana.com/api/v1/block/experience');
