...
function myajaxFileUpload(path,id) {

    var timestamp2 = Date.parse(new Date());
   var s = {
       //    /new/upload_file.php?tag=
       //    /new/upload_file.php?tag=
        url: path+'?tag=' + timestamp2+"&id="+id, //用于文件上传的服务器端请求地址
