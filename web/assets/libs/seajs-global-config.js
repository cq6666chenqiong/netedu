...
seajs.config({
    alias: {
        ...
        'myBanana.linkselect': 'myBanana/linkselect/1.0/linkselect-debug.js',
        'myBanana.webuploader': 'myBanana/webuploader/1.0.2/web-uploader.js',
        'myBanana.imagecrop': 'myBanana/imagecrop/1.0.0/image-crop.js',
        'myBanana.autocomplete': 'myBanana/autocomplete/1.0.0/autocomplete.js',
        'myBanana.selecttree': 'myBanana/ztree/0.0.1/select-tree.js',
        'myBanana.mimetypes': 'myBanana/mimetypes/0.0.1/mime-types',
