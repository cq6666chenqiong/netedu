define(function(require, exports, module) {
    ...
    var DocumentPlayer = Widget.extend({
        attrs: {
            swfFileUrl:'',
            pdfFileUrl:'',
            swfPlayerUrl:'../../bundles/topxiaweb/js/controller/swf/myBananaViewer.swf',
            swfPlayerWidth:'100%',
            swfPlayerheight:'100%',
            watermark: ''
        },
        ...
        initPDFJSViewer: function($thiz) {
            self=this;
            $("html").attr('dir','ltr');
            var jsPath = 'http://opencdn.myBanana.net/pdf.js/v3/viewer.html#'+self.attrs.pdfFileUrl.value;
