...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/delete/materials$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/work')) {
            // school_work
            if (preg_match('#^/work/(?P<userId>[^/]++)/index$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'school_work')), array (  '_controller' => 'Topxia\\WebBundle\\Controller\\CourseWorkController::indexAction',));
            }

            // school_work_add
            if (preg_match('#^/work/(?P<userId>[^/]++)/add$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'school_work_add')), array (  '_controller' => 'Topxia\\WebBundle\\Controller\\CourseWorkController::addAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            // course_bat_student
            if (preg_match('#^/course/(?P<courseId>[^/]++)/batstudent$#s', $pathinfo, $matches)) {
            ...
            // course_give_bat_student
            if (preg_match('#^/course/(?P<courseId>[^/]++)/givebatstudent$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_give_bat_student')), array (  '_controller' => 'Topxia\\WebBundle\\Controller\\CourseWorkController::batstudent2indexAction',));
            }

        }

        // course_video
        if ($pathinfo === '/myvideo/index') {
            return array (  '_controller' => 'Topxia\\WebBundle\\Controller\\MyVideoController::indexAction',  '_route' => 'course_video',);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/sorce/statistical')) {
                // admin_sorce_statistical
                if ($pathinfo === '/admin/sorce/statistical') {
                    return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\SorceStatisticalController::indexAction',  '_route' => 'admin_sorce_statistical',);
                }

                // admin_sorce_statisticaldepartment
                if ($pathinfo === '/admin/sorce/statisticalByDepartment') {
                    return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\SorceStatisticalController::statisticalByDepartmentAction',  '_route' => 'admin_sorce_statisticaldepartment',);
                }
        ...
        if (0 === strpos($pathinfo, '/material')) {
            ...
            if (0 === strpos($pathinfo, '/materials/batch')) {
        ...
        if (0 === strpos($pathinfo, '/json')) {
            // json_query_courses
            if ($pathinfo === '/json/courses') {
                return array (  '_controller' => 'MaterialLib\\MaterialLibBundle\\Controller\\JSONAPIController::coursesAction',  '_route' => 'json_query_courses',);
            }

            // json_query_users
            if ($pathinfo === '/json/users') {
                return array (  '_controller' => 'MaterialLib\\MaterialLibBundle\\Controller\\JSONAPIController::usersAction',  '_route' => 'json_query_users',);
            }
        ...
        // custom_upload
        if ($pathinfo === '/custom/upload') {
            return array (  '_controller' => 'Custom\\WebBundle\\Controller\\BatDepartmentController::indexAction',  '_route' => 'custom_upload',);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if ($pathinfo === '/admin/upload/file') {
                return array (  '_controller' => 'CustomAdminBundle:BatDepartment:index',  '_route' => 'custom_admin_upload',);
            }
