...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'topxia.twig.menu_extension' => 'getTopxia_Twig_MenuExtensionService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_33a1332a2a01a3ea71f4041c2a3d412aa1270bab0a06c4614903db9215e80b4e');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '1hkcbroykc004gc8ko844co40g4kwco', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('topxia.twig.menu_extension'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'route_white_list' => array(
                0 => '/uploader/upload_callback',
                1 => '/uploader/process_callback',
                2 => '/coin/pay/return/alipay',
                3 => '/coin/pay/notify/alipay',
                4 => '/coin/pay/notify/wxpay',
                5 => '/pay/center/pay/alipay/return',
                6 => '/pay/center/pay/wxpay/notify',
                7 => '/pay/center/pay/alipay/notify',
                8 => '/live/verify',
                9 => '/course/order/pay/alipay/notify',
                10 => '/vip/pay_notify/alipay',
                11 => '/uploadfile/upload',
                12 => '/uploadfile/cloud_convertcallback',
                13 => '/uploadfile/cloud_convertcallback2',
                14 => '/uploadfile/cloud_convertcallback3',
                15 => '/uploadfile/cloud_convertheadleadercallback',
                16 => '/disk/upload',
                17 => '/file/upload',
                18 => '/editor/upload',
                19 => '/disk/convert/callback',
                20 => '/partner/phpwind/api/notify',
            ...
            'locale' => 'zh_CN',
            'secret' => '1hkcbroykc004gc8ko844co40g4kwco',
            'user_partner' => 'none',
            ...
            'kernel.secret' => '1hkcbroykc004gc8ko844co40g4kwco',
                ...
                'blocks' => array(
                    'left' => array(
                        ...
                        3 => array(
                            ...
                            'subTitle' => '',
                            'background' => '',
                            'defaultSubTitle' => '科室化学习体系，给你更多的课程相关服务。',
                ...
                'blocks' => array(
                    'left' => array(
                        0 => array(
                            ...
                            'defaultTitle' => '在线学习平台',
                            'subTitle' => '',
                            'defaultSubTitle' => '精选在线学习平台，满足你的学习兴趣。',
                            'id' => 'latestCourse',
                        ),
                        1 => array(
                            'title' => '',
